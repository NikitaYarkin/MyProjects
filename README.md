...
Нейронная сеть для определения цифр из датасета MNIST.

## Neuron_3.ipynb

Реализация нейронной сети из 3 нейронов.За основу взят класс Neuron, который  реализовыван ранее.Комбинируя выходы отдельных нейронов  получим более сложную разделяющую границу.

## Practics_1.ipynb

Практическая работа на выявление оттока клиентов телеком компании.
...
## orb_slam.py
Задача CV.Построить траекторию движения камеры у человека используя OpenCV.
