...
### Цель практической работы: решить задачи по теме “Алгоритмы и 
структуры данных.
### Задача практической работы: закрепить знания по пройденному 
материалу. Для работы Вам потребуется на выбор:
### Задачи:
2.1. Выполнить 
...
2.2. Посчитать четные и нечетные цифры введенного натурального 
числа. Например, если введено число 34560, в нем 3 четные 
цифры 
(4, 6 и 0) и 2 нечетные (3 и 5).
2.3. В массиве случайных целых чисел поменять местами 
минимальный и максимальный элементы.
2.4. Отсортируйте по убыванию методом пузырька одномерный 
...
идут.
2.5. Отсортируйте по возрастанию методом слияния одномерный 
веществе
...
2.7. Закодируйте любую строку по алгоритму Хаффма
